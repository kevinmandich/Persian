...
class Territory(object):
  ...
  def __init__(self, name, type_, supplies, castles, consolidation, port, \
               adjacent_port, garrison, owner, neighbors, footmen, knight, \
...
Territory(name='Ironmans Bay', \
          ...
          garrison=0, \
          owner='greyjoy', \
          neighbors=['Pyke','Sunset Sea','The Golden Sound','Riverrun','Seagard','Greywater Watch','Flints Finger'], \
          footmen=0, \
          knight=0, \
          siege=0, \
          ships=1, \
